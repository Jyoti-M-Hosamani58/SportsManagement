...
urlpatterns = [
    ...
    path('get_coach_details/', views.get_coach_details, name='get_coach_details'),
    ...
    path('dist_receipt/<str:receipt>/', views.dist_receipt, name='dist_receipt'),
    ...
    path('customer_dist_receipt/<str:receipt>/', views.customer_dist_receipt, name='customer_dist_receipt'),
    ...
    path('get_coach_type/<int:coach_id>/', views.get_coach_type, name='get_coach_type'),
    path('get_session_price/', views.get_session_price, name='get_session_price'),
    path('get_enquiry_name', views.get_enquiry_name, name='get_enquiry_name'),
    path('get_enquiry_details', views.get_enquiry_details, name='get_enquiry_details'),
    ...
    path('get_name_details/', views.get_name_details, name='get_name_details'),
    path('save_sale', views.save_sale, name='save_sale'),
    path('save_sale_customer', views.save_sale_customer, name='save_sale_customer'),
    ...
    path('increaseStock', views.increaseStock, name='increaseStock'),
    path('increaseStocklist', views.increaseStocklist, name='increaseStocklist'),
    path('decreaseStocklist', views.decreaseStocklist, name='decreaseStocklist'),
    path('decreaseStock', views.decreaseStock, name='decreaseStock'),
